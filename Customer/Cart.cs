...
internal partial class Cart : Form
{
    ...
    private void Cart_Load(object sender, EventArgs e)
    {
        ...
        TotalPriceLabel.Text = $"Total: ${Convert.ToDecimal(((DataTable)Program.DatabaseHandler.ExecuteQuery($"SELECT dbo.fn_GetTotalCartPrice({Login.User.Value}) AS TotalPrice")).Rows[0]["TotalPrice"])}";
    }
